...
import LabelCircular from '../../widgets/LabelCircular'
        ...
        <Grid item xs={12} md={7}  style={{ margin: "auto" }}>
          ...
          <form autoComplete="off" onSubmit={(e) => handleUpload(e)}>
            <FormControl fullWidth>
              ...
              {/* <CustomizedInput
                required
                label="Nhập nội dung blog tại đây..."
                name="content"
                variant="outlined"
                id="custom-css-outlined-input"
              ...
              <div style={{display:'flex', alignItems:'center'}}>
                ...
                <DefaultButton type='submit' className={classes.profile_button}>Đăng</DefaultButton>
            </div>
            </FormControl>
